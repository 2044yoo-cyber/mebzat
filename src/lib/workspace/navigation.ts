  ...
  // for, and it was previously five sections down.
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/tours",
        private: true,
        hint: "Walk a buyer through it without them leaving the house",
        keywords: ["360", "panorama", "virtual tour", "walkthrough", "vr"],
      },
      {
        id: "land",
        label: "Land & Plots",
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Used Items",
        icon: Recycle,
        href: "/marketplace/used",
        hint: "Second-hand goods — anyone can sell",
        keywords: [
          "used",
          "second hand",
          "secondhand",
      ...
      },
      {
        ...
        hint: "Hire rather than buy",
        keywords: ["rent", "hire", "rental", "scaffold", "ladder", "mixer"],
      },
      {
        ...
        hint: "Courses, models, plans and templates",
        keywords: ["course", "sketchup", "3d", "floor plan", "template", "file"],
      },
      {
        id: "furniture",
        label: "Furniture",
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Calculator,
        href: "/calculators",
        hint: "Concrete, rebar, blocks, tile, paint, cut lists and cost",
        keywords: [
          "calculator",
          "calculators",
          "concrete",
