...
export const BOARDS: Board[] = [
  ...
  {
    id: "mdf-18-walnut",
    label: "18 mm MDF, walnut laminate",
    thickness: 18,
    sheet: { length: 2440, width: 1220 },
  ...
  {
    id: "mdf-18-uv",
    label: "18 mm MDF UV, gloss",
    thickness: 18,
    sheet: { length: 2440, width: 1220 },
    grain: "none",
    appearance: { colour: "White", hex: "#f2f0ec", sheen: "gloss" },
    priceKey: "MDF UV 18mm",
    fallbackRate: 10000,
  },
  {
    id: "mdf-18-solid-uv",
    label: "18 mm solid UV, gloss",
    thickness: 18,
    sheet: { length: 2440, width: 1220 },
    grain: "none",
    appearance: { colour: "White", hex: "#f2f0ec", sheen: "gloss" },
  ...
  },
  {
    ...
    sheet: { length: 2440, width: 1220 },
    grain: "none",
    appearance: { colour: "White", hex: "#f2f0ec", sheen: "matt" },
    priceKey: "MDF 6mm",
    fallbackRate: 2000,
  },
