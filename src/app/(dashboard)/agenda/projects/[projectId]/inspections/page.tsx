...
import { InspectionRegister } from "@/components/agenda/site/inspection-register";
import { getInspections, getProjectPeople } from "@/lib/data/agenda-site";
...
export default async function Page({
  ...
  const [inspections, people] = await Promise.all([
