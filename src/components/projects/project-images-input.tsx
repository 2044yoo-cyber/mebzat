...
export function ProjectImagesInput({
  ...
  async function handleChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    // Counted rather than toasted per file: six photos held would otherwise
    // stack six toasts on top of a phone screen.
    let held = 0;
    let refused = 0;
    ...
    for (const file of files) {
      ...
      // this batch is fetchable by URL before it has been checked. Uploading
      // straight to project-images published the file the moment it landed.
